...
it). The user-facing manual is in [`doc/user/`](../user/index.md).
...
- [`triple-double.md`](triple-double.md) — the narrow triple-double path
  (`float64x3`, `exp_full_td`, `sincos_full_td`, the `cexpm1dd` regime split).
- [`math-gaps.md`](math-gaps.md) — unimplemented surface vs C23 `<math.h>` and
  Fortran intrinsics: candidates to implement later.
- [`boost-comparison.md`](boost-comparison.md) +
  [`boost-op-matrix.md`](boost-op-matrix.md) — correctness/perf reference
