...
Usage:
    python3 codegen/gen_constants.py          # regenerate the header
    python3 codegen/gen_constants.py --check  # verify without writing
...
def write_cpp(groups, f):
    f.write("// ==========================================================================\n")
    f.write("// AUTO-GENERATED by codegen/gen_constants.py — do not edit manually.\n")
    f.write("// Regenerate: python3 codegen/gen_constants.py\n")
    f.write("// ==========================================================================\n")
    f.write("#pragma once\n\n")
